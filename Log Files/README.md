<h1>Log Files</h1>
<p>Log Filesคือไฟล์ที่เก็บการกระทำ, กิจกรรม, สิ่งต่างๆที่เกิดขึ้นกับระบบไม่ว่าจะเกิดขึ้นจากผู้ใช้งาน, kernel, package ฯลฯ Log Filesส่วนใหญ่จะถูกจัดเก็บอยู่ในโฟลเดอร์/var/log 
